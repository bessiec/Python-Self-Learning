...
class TestListOperations(unittest.TestCase):
  ...
  ###Following are tests for part 1 ###
    ...
    def test_1_F_last_five(self):
        self.assertEqual(last_five(self.months), ['Aug', 'Sep', 'Oct', 'Nov', 'Dec'])
    ...
    def self_1_H_inner_four(self):
        self.assertEqual(inner_four(self.months), ['Mar', 'Apr', 'May', 'Jun'])
        self.assertEqual(inner_four(self.months), ['Mi', 'Fa', 'So', 'La'])
    ...
    def test_2_H_custom_reverse(self):
